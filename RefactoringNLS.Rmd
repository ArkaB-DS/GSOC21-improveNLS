...
?? can we find a simpler example??
Maybe take Hobbs or Croucher and modify the data and parameters??
...
Note that the answers for the parameters are NOT indexed. e.g. `coef(musc.2)` is a
long vectors, not separated by the `Strip` index.
=======
```
...
>>>>>>> 295cbfce65b61f5092eff5fa9112b9eafce01699
