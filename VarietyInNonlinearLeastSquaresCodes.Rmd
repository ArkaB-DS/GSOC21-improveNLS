...
Conditions for convergence of the Newton iteration and the Gauss-Newton iteration are rather a nuisance
to verify, and in any case we want a solution. @Hartley61 proposed that rather than use an iteration
