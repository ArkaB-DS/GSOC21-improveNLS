...
## A case that blocks `nls()` from running

The following example shows that even supplying "good" starting points does not allow
a usable Jacobian to be computed by `numericDeriv()`. This example is also in the 
document **RefactoringNLS**.
