...
>>>>>>> 10bf74516c497d55a6a6b5bd4eb059ceb52bd344
$$    H \delta = -g$$
...
@Levenberg44 predated Marquardt, but the latter seems to
...
Typically we can use $D = 1_n$ (the identity of order $n$), but @Marq63 showed that using the 
